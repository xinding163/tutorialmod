...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public LootTable.Builder copperOreLikeDrops(Block drop, Item dropItem) {
        ...
        return this.dropsWithSilkTouch(drop, (LootPoolEntry.Builder)this.applyExplosionDecay(drop, ((LeafEntry.Builder) ItemEntry.builder(dropItem).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 5.0f)))).apply(ApplyBonusLootFunction.oreDrops(impl.getOrThrow(Enchantments.FORTUNE)))));
    }
}
